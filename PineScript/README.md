...
### Clean Dashboard (Top Center - Horizontal):

```
┌──────────┬─────────┬─────────┬─────────┬─────────┐
│ PRESSURE │   NOW   │ 5 BARS  │ 15 BARS │   DAY   │
├──────────┼─────────┼─────────┼─────────┼─────────┤
│   Buy    │  65.3%  │  58.2%  │  62.1%  │ BULLISH │
├──────────┼─────────┼─────────┼─────────┼─────────┤
│   Sell   │  34.7%  │  41.8%  │  37.9%  │         │
└──────────┴─────────┴─────────┴─────────┴─────────┘
```

**That's it.** Simple. Clean. Horizontal. Easy to scan.
...
**Layout:** Horizontal (5 columns × 3 rows)

**Size:** Compact and wide (easy to scan left-to-right)
